...
const SG_COOR = { lat: -23.17944, lng: -45.88694 };
        ...
        placesService.textSearch(placesRequest, ((response) => {
            ...
            for (let i = 0; i < responseLimit; i++) {
                ...
                const directionRequest = {
                    origin: markerLatLng,
                    destination: address, // Address of boteco place
                    travelMode: 'DRIVING',
                }
    ...
    render() {
        ...
        return (
          <div className="w-100 d-flex py-4 flex-wrap justify-content-center">
            <h1 className="w-100 fw-md">Buscador de Boteco!</h1>
            {/* Constraints section */}
            ...
            <section className="col-8 h-lg">
              <GoogleMapReact
                bootstrapURLKeys={{
                  key: 'AIzaSyAcHw6fAh4CkFyS5k5o0wPz1TdiYgDF958',
              ...
              <>
                ...
                <section className="col-12">
                  <div className="d-flex flex-column justify-content-center">
                    <h1 className="mb-4 fw-md">Achamos estes botecos!</h1>
