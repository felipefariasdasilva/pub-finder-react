...
Buscador de bares/botecos em um mapa, através da [Google Maps API](https://cloud.google.com/maps-platform).
...
```
https://github.com/felipefariasdasilva/pub-finder-react.git
```
